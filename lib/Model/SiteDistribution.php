...
/**
 * SiteDistribution Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SiteDistribution implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SiteDistribution';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['property1'] === null) {
            $invalidProperties[] = "'property1' can't be null";
        }
        if ($this->container['property2'] === null) {
            $invalidProperties[] = "'property2' can't be null";
        }
     ...
     * Sets property1
     *
     * @param object $property1 property1
     *
     * @return $this
     */
     ...
     * Sets property2
     *
     * @param object $property2 property2
     *
     * @return $this
     */
