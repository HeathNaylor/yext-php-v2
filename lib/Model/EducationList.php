...
/**
 * EducationList Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EducationList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EducationList';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['year_completed'] === null) {
            $invalidProperties[] = "'year_completed' can't be null";
        }
     ...
     * Sets year_completed
     *
     * @param string $year_completed year_completed
     *
     * @return $this
     */
