<?php
/**
 * EntitiesCreateHealthcareProfessionalRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * EntitiesCreateHealthcareProfessionalRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EntitiesCreateHealthcareProfessionalRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Entities:Create(HealthcareProfessional)Request';
